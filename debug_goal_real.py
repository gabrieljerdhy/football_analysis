        ...
        if 1 in ball_track and ball_track[1]:
            ...
            if ball_position:
                ...
                if (left_area['x_min'] <= x <= left_area['x_max'] and 
                    ...
                    print(f"🥅 Ball in LEFT goal area at frame {frame_num}: {ball_position}")
                ...
                if (right_area['x_min'] <= x <= right_area['x_max'] and 
                    ...
                    print(f"🥅 Ball in RIGHT goal area at frame {frame_num}: {ball_position}")
...
def create_visual_debug_video(video_path, output_path, max_frames=100):
    ...
    for frame_num, frame in enumerate(debug_frames):
        ...
        cv2.rectangle(debug_frame, 
                     ...
                     (0, 255, 0), 3)
        cv2.putText(debug_frame, "LEFT GOAL", 
        ...
        cv2.rectangle(debug_frame,
                     ...
                     (0, 0, 255), 3)
        cv2.putText(debug_frame, "RIGHT GOAL",
        ...
        if 1 in tracks["ball"][frame_num] and tracks["ball"][frame_num][1]:
            ...
            if ball_position:
                ...
                cv2.putText(debug_frame, f"BALL", 
        ...
        cv2.putText(debug_frame, f"Left: {left_area['x_min']}-{left_area['x_max']}", 
                   (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
        cv2.putText(debug_frame, f"Right: {right_area['x_min']}-{right_area['x_max']}", 
