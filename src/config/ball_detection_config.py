...
class BallDetectionConfig:
    ...
    def validate_config(self):
        ...
        if not os.path.exists(self.general_model_path):
            raise FileNotFoundError(f"General model not found: {self.general_model_path}")
        
        if self.enable_enhanced_ball_detection and not os.path.exists(self.ball_model_path):
            print(f"⚠️ Ball model not found: {self.ball_model_path}. Enhanced ball detection will be disabled.")
